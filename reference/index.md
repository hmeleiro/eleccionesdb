...
- [`get_provincias()`](https://eleccionesdb-r.spainelectoralproject.com/reference/get_provincias.md)
  : Results by province
- [`get_municipios()`](https://eleccionesdb-r.spainelectoralproject.com/reference/get_municipios.md)
  : Results by municipality
- [`get_secciones()`](https://eleccionesdb-r.spainelectoralproject.com/reference/get_secciones.md)
...
[`vignette("autodespliegue")`](https://eleccionesdb-r.spainelectoralproject.com/articles/autodespliegue.md)
para más detalles.

- [`edb_set_api_key()`](https://eleccionesdb-r.spainelectoralproject.com/reference/edb_set_api_key.md)
  : Set the EleccionesDB API key
- [`edb_get_api_key()`](https://eleccionesdb-r.spainelectoralproject.com/reference/edb_get_api_key.md)
...
- [`edb_get_base_url()`](https://eleccionesdb-r.spainelectoralproject.com/reference/edb_get_base_url.md)
  : Get the current EleccionesDB API base URL
- [`edb_set_backend()`](https://eleccionesdb-r.spainelectoralproject.com/reference/edb_set_backend.md)
  : Configure the EleccionesDB data backend
- [`edb_get_backend()`](https://eleccionesdb-r.spainelectoralproject.com/reference/edb_get_backend.md)
...
- [`edb_check_sqlite_update()`](https://eleccionesdb-r.spainelectoralproject.com/reference/edb_check_sqlite_update.md)
